...
import 'package:todo/config/di/di_container.dart' as _i373;
import 'package:todo/config/interceptor/auth_interceptor.dart' as _i929;
import 'package:todo/config/interceptor/refresh_token.dart' as _i123;
...
import 'package:todo/service/app_version_service.dart' as _i750;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.singleton<_i929.AuthInterceptor>(() => _i929.AuthInterceptor());
    gh.lazySingleton<_i528.PrettyDioLogger>(() => diModule.prettyDioLogger);
    gh.lazySingleton<_i361.Dio>(() => diModule.create());
    gh.lazySingleton<_i123.RefreshToken>(() => _i123.RefreshToken());
    gh.lazySingleton<_i750.AppVersionService>(() => _i750.AppVersionService());
...
class _$DiModule extends _i373.DiModule {}
