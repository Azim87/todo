...
class _TodoApiService implements TodoApiService {
  ...
  @override
  Future<SignupResponse> signup({required Map<String, dynamic> body}) async {
  ...
  Future<TodoSuccessResponse> addTodo(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<TodoSuccessResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TodoSuccessResponse _value;
    try {
      _value = TodoSuccessResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<TodoSuccessResponse> deleteTodo({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
